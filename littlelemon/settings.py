...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-r-%0eqcja86asp_+*1@3d6t9wm65$7^p*v^m961p@)w7*3ob0n')
...
DATABASES = {
    'default': {
        ...
        # If your host requires SSL, add the following:
        # 'OPTIONS': {
        #     'ssl': {
        #         'ca': os.getenv('DB_SSL_CA', '<path-to-ca-cert-file>'),
        #         'verify_cert': True,
        #     }
        # }
    }
